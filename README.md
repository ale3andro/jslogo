...
Με τη βοήθεια του gemini, έκανα μια σειρά από μικρές αλλαγές:

(0) Ελληνική μετάφραση

(1) Για τις στροφές δεξιά και αριστερά έγινε προεπιλογή η τιμή των 90 μοιρών (για ευκολία χρήσης από μικρότερες τάξεις του Δημοτικού όπου οι μαθητές δεν γνωρίζουν το μέτρο των γωνιών). Διατηρήθηκε η αρχική πρόνοια για στροφή σε οποιαδήποτε τιμή μοιρών 0-360 με χρήση του argument **unlockTurns** στο URL ( **index.html?unlockTurns** )

(2) Προθήκη προεπιλεγμένης τιμής pixels για κινήσεις μπροστά και πίσω τα 100 εικονοστοιχεία.


Χρήση
===============================

Online χρήση [εδώ](https://ale3andro.github.io/jslogo)

Αν θέλεις να "ξεκλειδώσεις" τις στροφές σε όλες τις τιμές μοιρών, πρέπει να περάσεις το argument **unlockTurns** στο URL, δηλαδή **index.html?unlockTurns**

Online χρήση με στροφές σε όλες τις τιμές μοιρών [εδώ](https://ale3andro.github.io/jslogo?unlockTurns)
