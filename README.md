...
(1) Για τις στροφές δεξιά και αριστερά έγινε προεπιλογή η τιμή των 90 μοιρών (για ευκολία χρήσης από μικρότερες τάξεις που δεν γνωρίζουν το μέτρο των γωνιών). Διατηρήθηκε η αρχική πρόνοια για στροφή σε οποιαδήποτε τιμή μοιρών 0-360 με χρήση του argument **unlockTurns** στο URL ( **index.html?unlockTurns** )
